...
# code of Field: https://github.com/pytorch/text/blob/master/torchtext/data/field.py#L61
...
class Encoder(nn.Module):
    ...
    def forward(self, src):
        ...
        # hidden (the final hidden state for each layer, stacked on top of each other)
        # and cell (the final cell state for each layer, stacked on top of each other)
        return hidden, cell
